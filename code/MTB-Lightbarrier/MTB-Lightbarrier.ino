...
void determineTodayStorageByte() {
  int address = 3;
  short value = 1;
  while (value != 0 && address++ < EEPROM.length()) {
...
/*
void storeLengthOfCurrentDay() {
  long millisRun = millis() - todayStartedAtMillis;
  short hours = millisRun / 3600000;
...
//************ timer
//Timer1 Prescaler = 1024; Preload = 58593; Actual Interrupt Time = 60,000256 s
